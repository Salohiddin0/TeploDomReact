      ...
      <header className='max-w-7xl mx-auto px-4 mt-16'>
        ...
        <div className='grid grid-cols-6 gap-10 mt-8'>
          {visibleCategories.map(category => (
            <div
              key={category.id}
              className='bg-white w-[160px] h-[202px] text-center rounded-lg p-5 shadow-md'
            >
              <img className='mb-6' src={category.image} alt={category.title} />
